...
+ (UILabel *)createLabelWithFrame:(CGRect)frame
                         FontSize:(int)fontSize
                             Text:(NSString *)text
{
    return [LSUIFactory createLabelWithFrame:frame FontSize:fontSize Text:text textColor:[UIColor blackColor]];
}
...
{
    return [LSUIFactory createLabelWithFrame:frame FontSize:fontSize Text:text textColor:[UIColor blackColor] NSTextAlignment:NSTextAlignmentLeft];
}


+ (UILabel_LSLabel *)createLabelWithFrame:(CGRect)frame
                                 FontSize:(int)fontSize
                                     Text:(NSString *)text
                                textColor:(UIColor *)color
                          NSTextAlignment:(NSTextAlignment)alignment
{
    ...
    UILabel_LSLabel *label = [[UILabel_LSLabel alloc] initWithFrame:frame];  //
