...
@implementation PersonStyleTwoTableViewCell
//重写init方法构建cell内容
...
-(UILabel *)titleShowLab
{
    if (_titleShowLab == nil) {
        //描述
        _titleShowLab = [[UILabel alloc] initWithFrame:CGRectMake(kScreenW/2, 14, kScreenW/2-14, 23)];
