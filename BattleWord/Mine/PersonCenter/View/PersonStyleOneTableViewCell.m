...
@implementation PersonStyleOneTableViewCell
//重写init方法构建cell内容
...
-(UILabel *)titleLab
{
    if (_titleLab == nil) {
        //描述
        _titleLab = [[UILabel alloc] initWithFrame:CGRectMake(15, 14, kScreenW/2-15, 23)];
...
-(UILabel *)titleShowLab
{
    if (_titleShowLab == nil) {
        //描述
        _titleShowLab = [[UILabel alloc] initWithFrame:CGRectMake(kScreenW/2, 14, kScreenW/2-38, 23)];
...
-(UIImageView *)arrowImage
{
    if (_arrowImage == nil) {
        ...
        _arrowImage = [[UIImageView alloc] initWithFrame:CGRectMake(kScreenW -33, 17, 18, 18)];
